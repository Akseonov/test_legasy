const cart = {
  ...
  /**
   * Добавить товар в корзину или изменить его количество, если уже имеется
   * @param item - Данные товара для отправки
  ...
  /**
   * Ставим обработчики событий на кнопку покупки товара и кнопку закрытия окна сообщения о покупке
   * @private
   */
  _handleActions() {
  ...
  /**
   * Запрос данных карзины с сервера
   */
  getItem() {
    fetch(this.url)
